...
?>
        <table>
            ...
            <tr>
                ...
                <th <?php echo $style_row_head;  ?> >Código Barra</th>
				<th <?php echo $style_row_head;  ?> >Código Item</th>
				...
				<th <?php echo $style_row_head;  ?> >Precio Compra</th>
...
?>
			<tr>
				...
				<td <?php echo $style_row_data;  ?> > <?php echo $data['precio_compra'];  ?> </t
