            ...
            success: function(response)
            {
                if(response != 'error')
                {
                    ...
                    $('.bodyModal').html('<form action="" id="form_activeUser" class="formModal" name="form_activeUser" >'+
                        ...
                        '<table class="tblModal"><tbody>'+
                                '<tr><td class="textright">Código:</td><td class="textleft"><strong>'+info.coditem+'</strong></td></tr>'+
                                '<tr><td class="textright">Descripción:</td><td class="textleft"><strong>'+info.descripcion+'</strong></td></tr>'+
                                '<tr><td class="textright">Precio Compra:</td><td class="textleft"><strong>'+info.precio_compra+'</strong></td></tr>'+
				'<tr><td class="textright">Preciooo:</td><td class="textleft"><strong>'+info.precio+'</strong></td></tr>'+
